...
const occupiedTimes = [
    ...
    { date: dayjs('2024-07-24'), times: ['11:00', '11:30', '12:00', '12:30', '13:00', '13:30', '15:00', '15:30', '16:00', '16:30', '17:00', '17:30'] },
];
...
const areAllSlotsOccupied = (date: Dayjs) => {
    ...
    ].map(time => dayjs(date).hour(parseInt(time.split(':')[0])).minute(parseInt(time.split(':')[1])));
